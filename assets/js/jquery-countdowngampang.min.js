...
(function ($) {
    ...
    $.fn.CountdownGampang = function (options, callback) {
        ...
        var countdown = setInterval(function () {
            ...
            const endEpoch = Math.floor(new Date("2025-02-13 23:59:59").getTime() / 1000); // Convert end date to epoch seconds
            let seconds = endEpoch - now;
            ...
            element.find('.ClassyCountdown-days input').val(365.25 - days).trigger('change');
            element.find('.ClassyCountdown-hours input').val(23 - hours).trigger('change');
            element.find('.ClassyCountdown-minutes input').val(59 - minutes).trigger('change');
            element.find('.ClassyCountdown-seconds input').val(59 - seconds).trigger('change');
